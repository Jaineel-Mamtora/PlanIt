                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () async {
                        if (_controller.text.trim().isEmpty ||
                          ...
                          Fluttertoast.showToast(
                            msg:
                                TaskConstants.PLEASE_ENTER_TITLE_AND_START_TIME,
                          );
                          return;
                        }
                        ...
                        if (model.isTaskTimeSlotOverlapping(
                          ...
                          var task = Task(
                            ...
                            fromTime: _selectedFromTime.millisecondsSinceEpoch,
                          ...
                          int id = await _databaseService.insert(task.toJson());
                          if (_defaultChoiceIndex >= 0) {
                            await _notificationHandler.showBigTextNotification(
                              id: id,
                              title: task.priority != null && task.priority != 0
                                  ? sprintf(
